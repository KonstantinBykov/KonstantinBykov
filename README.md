### Привет, меня зовут Константин, я аналитик данных.

Образование:  
                УГТУ - Разработка и эксплуатация нефтяных и газовых месторождений.
karpov.courses - Аналитик данных. sql-ex, stratascratch.com, stepik.org  и изучаю английский язык (B-1). Сейчас нахожусь в поисках работы.
